<template>
  <div id="privacy">
    <section id="heading">
      ...
      <p class="sub-header">Effective date: September 12, 2021</p>
      <p>
        Baselime (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) operates
        the
        <a href="/">https://baselime.io</a> website (the &quot;Service&quot;).
      </p>
      <p>
        Your privacy is important to us. It is Baselime's policy to respect your
        privacy regarding any information we may collect from you across our
        website, <a href="https://baselime.io">https://baselime.io</a>, and
    ...
    <section>
      ...
      <p>
        ...
        identify you (&quot;Personal Information&quot;). Personally identifiable
      ...
      <ul>
        ...
        <li>
          preference cookies, used to remember your preferences and various
          settings;
        </li>
    ...
    <section>
      ...
      <p>
        ...
        United Kingdom, the United States, the Netherlands and Germany, or where
        we or our partners, affiliates and third-party providers maintain
        facilities. By providing us with your Personal Information, you consent
    ...
    <section>
      ...
      <p>
        ...
        aware that your Children has provided us with Personal Information,
    ...
    <section>
      ...
      <p>
        We will take reasonable steps to let users know about changes via our
        website. Your continued use of this site after any changes to this
        policy will be regarded as acceptance of our practices around privacy
    ...
    <section>
      ...
      <p>
        Baselime legal basis for collecting and using the Personal Information
      ...
      <ul>
        ...
        <li>you have given Baselime permission to do so;</li>
        <li>
          processing your Personal Information is in Baselime legitimate
          interests; and
        </li>
        <li>we need to comply with the law.</li>
      </ul>
      <p>
        Baselime will retain your Personal Information only for as long as is
        necessary for the purposes set out in this Privacy Policy. We will
        retain and use your information to the extent necessary to comply with
        our legal obligations, resolve disputes, and enforce our policies. If
        you are a resident of the European Economic Area (EEA), you have certain
        data protection rights. If you wish to be informed what Personal
    ...
    <section>
      ...
      <p><a href="mailto:support@baselime.io">support@baselime.io</a></p>
      <p>
        Use subject
        <span style="font-weight: bold">"ATTN: DATA CONTROLLER"</span>
      </p>
    </section>
  </div>
</template>
