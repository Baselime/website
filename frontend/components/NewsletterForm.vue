<template>
  <form class="mt-4 sm:flex sm:max-w-md" @submit.prevent="subscribe">
    ...
    <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
      <button
        type="submit"
        class="w-full bg-baseGreen border border-transparent rounded-2xl py-2 px-6 h-full flex items-center justify-center text-base font-medium text-white hover:-translate-y-0.5 base-transition"
